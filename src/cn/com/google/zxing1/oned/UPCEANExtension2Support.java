...
final class UPCEANExtension2Support {
  ...
  cn.com.google.zxing1.Result decodeRow(int rowNumber, cn.com.google.zxing1.common.BitArray row, int[] extensionStartRange) throws cn.com.google.zxing1.NotFoundException {
    ...
    cn.com.google.zxing1.Result extensionResult =
        new cn.com.google.zxing1.Result(resultString,
                   null,
                   new ResultPoint[] {
                       new ResultPoint((extensionStartRange[0] + extensionStartRange[1]) / 2.0f, (float) rowNumber),
                       new ResultPoint((float) end, (float) rowNumber),
                   },
                   cn.com.google.zxing1.BarcodeFormat.UPC_EAN_EXTENSION);
  ...
  int decodeMiddle(cn.com.google.zxing1.common.BitArray row, int[] startRange, StringBuilder resultString) throws cn.com.google.zxing1.NotFoundException {
