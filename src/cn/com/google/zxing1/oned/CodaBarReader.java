...
public final class CodaBarReader extends OneDReader {
  ...
  @Override
  public cn.com.google.zxing1.Result decodeRow(int rowNumber, cn.com.google.zxing1.common.BitArray row, Map<cn.com.google.zxing1.DecodeHintType,?> hints) throws cn.com.google.zxing1.NotFoundException {
    ...
    if (hints == null || !hints.containsKey(cn.com.google.zxing1.DecodeHintType.RETURN_CODABAR_START_END)) {
    ...
    return new cn.com.google.zxing1.Result(
        ...
        null,
        new cn.com.google.zxing1.ResultPoint[]{
            new cn.com.google.zxing1.ResultPoint(left, (float) rowNumber),
            new cn.com.google.zxing1.ResultPoint(right, (float) rowNumber)},
        cn.com.google.zxing1.BarcodeFormat.CODABAR);
  }

  void validatePattern(int start) throws cn.com.google.zxing1.NotFoundException {
   ...
   */
  private void setCounters(cn.com.google.zxing1.common.BitArray row) throws cn.com.google.zxing1.NotFoundException {
    counterLength = 0;
  ...
  private int findStartPattern() throws cn.com.google.zxing1.NotFoundException {
