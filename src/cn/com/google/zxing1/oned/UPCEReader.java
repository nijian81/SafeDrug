...
public final class UPCEReader extends UPCEANReader {
  ...
  @Override
  protected int decodeMiddle(cn.com.google.zxing1.common.BitArray row, int[] startRange, StringBuilder result)
  ...
  @Override
  protected int[] decodeEnd(cn.com.google.zxing1.common.BitArray row, int endStart) throws cn.com.google.zxing1.NotFoundException {
    return findGuardPattern(row, endStart, true, MIDDLE_END_PATTERN);
  }

  @Override
  protected boolean checkChecksum(String s) throws cn.com.google.zxing1.FormatException {
