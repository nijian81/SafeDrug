...
final class DecodedBitStreamParser {
  ...
  static cn.com.google.zxing1.common.DecoderResult decode(byte[] bytes, int mode) {
    ...
    return new cn.com.google.zxing1.common.DecoderResult(bytes, result.toString(), null, String.valueOf(mode));
  }
