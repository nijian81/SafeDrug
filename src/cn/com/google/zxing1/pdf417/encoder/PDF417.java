...
public final class PDF417 {
  ...
  private cn.com.google.zxing1.pdf417.encoder.BarcodeMatrix barcodeMatrix;
  private boolean compact;
  private cn.com.google.zxing1.pdf417.encoder.Compaction compaction;
  ...
  public PDF417(boolean compact) {
    ...
    compaction = cn.com.google.zxing1.pdf417.encoder.Compaction.AUTO;
  ...
  public cn.com.google.zxing1.pdf417.encoder.BarcodeMatrix getBarcodeMatrix() {
  ...
  private void encodeLowLevel(CharSequence fullCodewords,
                              ...
                              cn.com.google.zxing1.pdf417.encoder.BarcodeMatrix logic) {
   ...
   * @throws cn.com.google.zxing1.WriterException if the contents cannot be encoded in this format
   */
  public void generateBarcodeLogic(String msg, int errorCorrectionLevel) throws cn.com.google.zxing1.WriterException {
    ...
    barcodeMatrix = new cn.com.google.zxing1.pdf417.encoder.BarcodeMatrix(rows, cols);
   ...
   */
  private int[] determineDimensions(int sourceCodeWords, int errorCorrectionCodeWords) throws cn.com.google.zxing1.WriterException {
    float ratio = 0.0f;
    int[] dimension = null;
    ...
    if (dimension == null) {
      throw new cn.com.google.zxing1.WriterException("Unable to fit message in columns");
    }
   ...
   */
  public void setCompaction(cn.com.google.zxing1.pdf417.encoder.Compaction compaction) {
