...
final class DetectionResultRowIndicatorColumn extends DetectionResultColumn {
  ...
  DetectionResultRowIndicatorColumn(cn.com.google.zxing1.pdf417.decoder.BoundingBox boundingBox, boolean isLeft) {
    super(boundingBox);
    this.isLeft = isLeft;
  }
  ...
  int adjustCompleteIndicatorColumnRowNumbers(BarcodeMetadata barcodeMetadata) {
    ...
    cn.com.google.zxing1.pdf417.decoder.BoundingBox boundingBox = getBoundingBox();
  ...
  int[] getRowHeights() throws cn.com.google.zxing1.FormatException {
