...
import cn.com.google.zxing1.pdf417.PDF417Common;
import cn.com.google.zxing1.pdf417.decoder.ec.ErrorCorrection;
...
public final class PDF417ScanningDecoder {
  ...
  public static DecoderResult decode(BitMatrix image,
                                     ...
                                     int maxCodewordWidth) throws NotFoundException, cn.com.google.zxing1.FormatException, ChecksumException {
    cn.com.google.zxing1.pdf417.decoder.BoundingBox boundingBox = new cn.com.google.zxing1.pdf417.decoder.BoundingBox(image, imageTopLeft, imageBottomLeft, imageTopRight, imageBottomRight);
    cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn leftRowIndicatorColumn = null;
    cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn rightRowIndicatorColumn = null;
    cn.com.google.zxing1.pdf417.decoder.DetectionResult detectionResult = null;
    for (int i = 0; i < 2; i++) {
    ...
    for (int barcodeColumnCount = 1; barcodeColumnCount <= maxBarcodeColumn; barcodeColumnCount++) {
      ...
      cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn detectionResultColumn;
      if (barcodeColumn == 0 || barcodeColumn == maxBarcodeColumn) {
        detectionResultColumn = new cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn(boundingBox, barcodeColumn == 0);
      } else {
        detectionResultColumn = new cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn(boundingBox);
      }
  ...
  private static cn.com.google.zxing1.pdf417.decoder.DetectionResult merge(cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn leftRowIndicatorColumn,
                                       cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn rightRowIndicatorColumn)
      throws NotFoundException, cn.com.google.zxing1.FormatException {
    ...
    cn.com.google.zxing1.pdf417.decoder.BoundingBox boundingBox = cn.com.google.zxing1.pdf417.decoder.BoundingBox.merge(adjustBoundingBox(leftRowIndicatorColumn),
            adjustBoundingBox(rightRowIndicatorColumn));
    return new cn.com.google.zxing1.pdf417.decoder.DetectionResult(barcodeMetadata, boundingBox);
  }

  private static cn.com.google.zxing1.pdf417.decoder.BoundingBox adjustBoundingBox(cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn rowIndicatorColumn)
      throws NotFoundException, cn.com.google.zxing1.FormatException {
  ...
  private static BarcodeMetadata getBarcodeMetadata(cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn leftRowIndicatorColumn,
                                                    cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn rightRowIndicatorColumn) {
  ...
  private static cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn getRowIndicatorColumn(BitMatrix image,
                                                                         cn.com.google.zxing1.pdf417.decoder.BoundingBox boundingBox,
                                                                         ResultPoint startPoint,
                                                                         boolean leftToRight,
                                                                         int minCodewordWidth,
                                                                         int maxCodewordWidth) {
    cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn rowIndicatorColumn = new cn.com.google.zxing1.pdf417.decoder.DetectionResultRowIndicatorColumn(boundingBox,
        leftToRight);
    for (int i = 0; i < 2; i++) {
  ...
  private static void adjustCodewordCount(cn.com.google.zxing1.pdf417.decoder.DetectionResult detectionResult, BarcodeValue[][] barcodeMatrix)
  ...
  private static DecoderResult createDecoderResult(cn.com.google.zxing1.pdf417.decoder.DetectionResult detectionResult) throws cn.com.google.zxing1.FormatException,
  ...
  private static DecoderResult createDecoderResultFromAmbiguousValues(int ecLevel,
      ...
      throws cn.com.google.zxing1.FormatException, ChecksumException {
  ...
  private static BarcodeValue[][] createBarcodeMatrix(cn.com.google.zxing1.pdf417.decoder.DetectionResult detectionResult) throws cn.com.google.zxing1.FormatException {
    ...
    int column = 0;
    for (cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn detectionResultColumn : detectionResult.getDetectionResultColumns()) {
  ...
  private static boolean isValidBarcodeColumn(cn.com.google.zxing1.pdf417.decoder.DetectionResult detectionResult, int barcodeColumn) {
    return barcodeColumn >= 0 && barcodeColumn <= detectionResult.getBarcodeColumnCount() + 1;
  }

  private static int getStartColumn(cn.com.google.zxing1.pdf417.decoder.DetectionResult detectionResult,
                                    int barcodeColumn,
                                    int imageRow,
                                    boolean leftToRight) {
  ...
  private static Codeword detectCodeword(BitMatrix image,
    ...
    int decodedValue = cn.com.google.zxing1.pdf417.decoder.PDF417CodewordDecoder.getDecodedValue(moduleBitCount);
  ...
  private static DecoderResult decodeCodewords(int[] codewords, int ecLevel, int[] erasures) throws cn.com.google.zxing1.FormatException,
      ChecksumException {
    ...
    DecoderResult decoderResult = cn.com.google.zxing1.pdf417.decoder.DecodedBitStreamParser.decode(codewords, String.valueOf(ecLevel));
   ...
   */
  private static void verifyCodewordCount(int[] codewords, int numECCodewords) throws cn.com.google.zxing1.FormatException {
