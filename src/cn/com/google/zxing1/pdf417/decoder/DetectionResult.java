...
final class DetectionResult {
  ...
  private final cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn[] detectionResultColumns;
  ...
  DetectionResult(BarcodeMetadata barcodeMetadata, BoundingBox boundingBox) {
    ...
    detectionResultColumns = new cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn[barcodeColumnCount + 2];
  }

  cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn[] getDetectionResultColumns() {
    ...
    int unadjustedCodewordCount = cn.com.google.zxing1.pdf417.PDF417Common.MAX_CODEWORDS_IN_BARCODE;
  ...
  private void adjustIndicatorColumnRowNumbers(cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn detectionResultColumn) {
  ...
  void setDetectionResultColumn(int barcodeColumn, cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn detectionResultColumn) {
    detectionResultColumns[barcodeColumn] = detectionResultColumn;
  }

  cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn getDetectionResultColumn(int barcodeColumn) {
    return detectionResultColumns[barcodeColumn];
  }

  @Override
  public String toString() {
    cn.com.google.zxing1.pdf417.decoder.DetectionResultColumn rowIndicatorColumn = detectionResultColumns[0];
