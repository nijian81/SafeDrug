...
class C40Encoder implements Encoder {
  ...
  @Override
  public void encode(cn.com.google.zxing1.datamatrix.encoder.EncoderContext context) {
    //step C
  ...
  private int backtrackOneCharacter(cn.com.google.zxing1.datamatrix.encoder.EncoderContext context,
  ...
  static void writeNextTriplet(cn.com.google.zxing1.datamatrix.encoder.EncoderContext context, StringBuilder buffer) {
   ...
   */
  void handleEOD(cn.com.google.zxing1.datamatrix.encoder.EncoderContext context, StringBuilder buffer) {
    int unwritten = (buffer.length() / 3) * 2;
