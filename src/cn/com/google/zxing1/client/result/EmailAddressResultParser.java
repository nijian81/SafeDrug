...
public final class EmailAddressResultParser extends ResultParser {
  ...
  @Override
  public cn.com.google.zxing1.client.result.EmailAddressParsedResult parse(cn.com.google.zxing1.Result result) {
    ...
    if (rawText.startsWith("mailto:") || rawText.startsWith("MAILTO:")) {
      ...
      return new cn.com.google.zxing1.client.result.EmailAddressParsedResult(tos, ccs, bccs, subject, body);
    } else {
      if (!cn.com.google.zxing1.client.result.EmailDoCoMoResultParser.isBasicallyValidEmailAddress(rawText)) {
        return null;
      }
      return new cn.com.google.zxing1.client.result.EmailAddressParsedResult(rawText);
    }
  }
