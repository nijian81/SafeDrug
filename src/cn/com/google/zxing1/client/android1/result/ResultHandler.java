...
import cn.com.google.zxing1.client.android1.Contents;
import cn.com.google.zxing1.client.android1.Intents;
import cn.com.google.zxing1.client.android1.LocaleManager;
import cn.com.google.zxing1.client.android1.PreferencesActivity;
import cn.com.google.zxing1.client.android1.book.SearchBookContentsActivity;
import cn.com.google.zxing1.client.result.ParsedResult;
import cn.com.google.zxing1.client.result.ParsedResultType;
...
public abstract class ResultHandler {
    ...
    private final cn.com.google.zxing1.Result rawResult;
    ...
    ResultHandler(Activity activity, ParsedResult result, cn.com.google.zxing1.Result rawResult) {
        this.result = result;
    ...
    final String fillInCustomSearchURL(String text) {
        ...
        if (rawResult != null) {
            ...
            if (url.contains("%t")) {
                ParsedResult parsedResultAgain = cn.com.google.zxing1.client.result.ResultParser.parseResult(rawResult);
