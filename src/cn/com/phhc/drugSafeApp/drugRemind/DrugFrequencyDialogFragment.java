 ...
 */
public class DrugFrequencyDialogFragment extends DialogFragment {
    ...
    public static DrugFrequencyDialogFragment newInstance(String sex) {
        DrugFrequencyDialogFragment frag = new DrugFrequencyDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.drug_frequency_dialog, container, false);
