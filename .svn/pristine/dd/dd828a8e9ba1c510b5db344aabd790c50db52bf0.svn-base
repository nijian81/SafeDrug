...
package cn.com.google.zxing1.client.android1.result.supplement;
...
public abstract class SupplementalInfoRetriever extends AsyncTask<Object,Object,Object> {
  ...
  public static void maybeInvokeRetrieval(TextView textView,
                                          cn.com.google.zxing1.client.result.ParsedResult result,
                                          HistoryManager historyManager,
                                          Context context) {
    if (result instanceof cn.com.google.zxing1.client.result.URIParsedResult) {
      SupplementalInfoRetriever uriRetriever = 
          new URIResultInfoRetriever(textView, (cn.com.google.zxing1.client.result.URIParsedResult) result, historyManager, context);
      uriRetriever.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
      SupplementalInfoRetriever titleRetriever = 
          new TitleRetriever(textView, (cn.com.google.zxing1.client.result.URIParsedResult) result, historyManager);
      titleRetriever.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    } else if (result instanceof cn.com.google.zxing1.client.result.ProductParsedResult) {
      cn.com.google.zxing1.client.result.ProductParsedResult productParsedResult = (cn.com.google.zxing1.client.result.ProductParsedResult) result;
    ...
    } else if (result instanceof cn.com.google.zxing1.client.result.ISBNParsedResult) {
      String isbn = ((cn.com.google.zxing1.client.result.ISBNParsedResult) result).getISBN();
