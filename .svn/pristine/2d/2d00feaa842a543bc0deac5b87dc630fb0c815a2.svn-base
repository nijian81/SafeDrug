...
package cn.com.google.zxing1.client.android1.result;
...
public final class CalendarResultHandler extends ResultHandler {
  ...
  public CalendarResultHandler(Activity activity, cn.com.google.zxing1.client.result.ParsedResult result) {
  ...
  public void handleButtonPress(int index) {
    if (index == 0) {
      cn.com.google.zxing1.client.result.CalendarParsedResult calendarResult = (cn.com.google.zxing1.client.result.CalendarParsedResult) getResult();
  ...
  public CharSequence getDisplayContents() {
    ...
    cn.com.google.zxing1.client.result.CalendarParsedResult calResult = (cn.com.google.zxing1.client.result.CalendarParsedResult) getResult();
    StringBuilder result = new StringBuilder(100);

    cn.com.google.zxing1.client.result.ParsedResult.maybeAppend(calResult.getSummary(), result);

    Date start = calResult.getStart();
    cn.com.google.zxing1.client.result.ParsedResult.maybeAppend(format(calResult.isStartAllDay(), start), result);
    ...
    if (end != null) {
      ...
      cn.com.google.zxing1.client.result.ParsedResult.maybeAppend(format(calResult.isEndAllDay(), end), result);
    }

    cn.com.google.zxing1.client.result.ParsedResult.maybeAppend(calResult.getLocation(), result);
    cn.com.google.zxing1.client.result.ParsedResult.maybeAppend(calResult.getOrganizer(), result);
    cn.com.google.zxing1.client.result.ParsedResult.maybeAppend(calResult.getAttendees(), result);
    cn.com.google.zxing1.client.result.ParsedResult.maybeAppend(calResult.getDescription(), result);
