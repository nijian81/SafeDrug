...
public final class MonochromeRectangleDetector {
   ...
   */
  public ResultPoint[] detect() throws cn.com.google.zxing1.NotFoundException {
   ...
   *  the barcode
   * @return a {@link cn.com.google.zxing1.ResultPoint} encapsulating the corner that was found
   * @throws cn.com.google.zxing1.NotFoundException if such a point cannot be found
   */
  private ResultPoint findCornerFromCenter(int centerX,
                                           ...
                                           int top,
                                           int bottom,
                                           int maxWhiteRun) throws cn.com.google.zxing1.NotFoundException {
    int[] lastRange = null;
