...
final class FieldParser {
  ...
  static String parseFieldsInGeneralPurpose(String rawInformation) throws cn.com.google.zxing1.NotFoundException {
  ...
  private static String processFixedAI(int aiSize, int fieldSize, String rawInformation) throws cn.com.google.zxing1.NotFoundException {
