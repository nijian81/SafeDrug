...
public enum CharacterSetECI {
   ...
   *   unsupported
   * @throws cn.com.google.zxing1.FormatException if ECI value is invalid
   */
  public static CharacterSetECI getCharacterSetECIByValue(int value) throws cn.com.google.zxing1.FormatException {
