...
package cn.com.google.zxing1.multi.qrcode.detector;

import cn.com.google.zxing1.ResultPoint;
import cn.com.google.zxing1.qrcode.detector.FinderPattern;
import cn.com.google.zxing1.qrcode.detector.FinderPatternInfo;
 ...
 *
 * <p>In contrast to {@link cn.com.google.zxing1.qrcode.detector.FinderPatternFinder}, this class will return an array of all possible
 ...
 * @author Hannes Erven
 */
final class MultiFinderPatternFinder extends cn.com.google.zxing1.qrcode.detector.FinderPatternFinder {
   ...
   */
  MultiFinderPatternFinder(cn.com.google.zxing1.common.BitMatrix image) {
    super(image);
  }

  MultiFinderPatternFinder(cn.com.google.zxing1.common.BitMatrix image, cn.com.google.zxing1.ResultPointCallback resultPointCallback) {
   ...
   */
  private FinderPattern[][] selectMutipleBestPatterns() throws cn.com.google.zxing1.NotFoundException {
  ...
  public FinderPatternInfo[] findMulti(Map<cn.com.google.zxing1.DecodeHintType,?> hints) throws cn.com.google.zxing1.NotFoundException {
    boolean tryHarder = hints != null && hints.containsKey(cn.com.google.zxing1.DecodeHintType.TRY_HARDER);
    boolean pureBarcode = hints != null && hints.containsKey(cn.com.google.zxing1.DecodeHintType.PURE_BARCODE);
    cn.com.google.zxing1.common.BitMatrix image = getImage();
