...
public final class EAN13Reader extends UPCEANReader {
  ...
  @Override
  protected int decodeMiddle(cn.com.google.zxing1.common.BitArray row,
                             int[] startRange,
  ...
  cn.com.google.zxing1.BarcodeFormat getBarcodeFormat() {
    return cn.com.google.zxing1.BarcodeFormat.EAN_13;
  }
   ...
   *  encode digits
   * @throws cn.com.google.zxing1.NotFoundException if first digit cannot be determined
   */
