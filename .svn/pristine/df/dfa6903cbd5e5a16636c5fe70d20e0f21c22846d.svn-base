...
public final class VEventResultParser extends ResultParser {
  ...
  @Override
  public CalendarParsedResult parse(cn.com.google.zxing1.Result result) {
  ...
  private static String matchSingleVCardPrefixedField(CharSequence prefix,
                                                      String rawText,
                                                      boolean trim) {
    List<String> values = cn.com.google.zxing1.client.result.VCardResultParser.matchSingleVCardPrefixedField(prefix, rawText, trim, false);
    return values == null || values.isEmpty() ? null : values.get(0);
  }

  private static String[] matchVCardPrefixedField(CharSequence prefix, String rawText, boolean trim) {
    List<List<String>> values = cn.com.google.zxing1.client.result.VCardResultParser.matchVCardPrefixedField(prefix, rawText, trim, false);
