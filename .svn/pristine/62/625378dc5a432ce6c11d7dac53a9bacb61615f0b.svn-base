...
import cn.com.google.zxing1.common.CharacterSetECI;
...
final class DecodedBitStreamParser {
  ...
  static DecoderResult decode(int[] codewords, String ecLevel) throws cn.com.google.zxing1.FormatException {
    StringBuilder result = new StringBuilder(codewords.length * 2);
    Charset encoding = DEFAULT_ENCODING;
    // Get compaction mode
    int codeIndex = 1;
    int code = codewords[codeIndex++];
    cn.com.google.zxing1.pdf417.PDF417ResultMetadata resultMetadata = new cn.com.google.zxing1.pdf417.PDF417ResultMetadata();
  ...
  private static int decodeMacroBlock(int[] codewords, int codeIndex, cn.com.google.zxing1.pdf417.PDF417ResultMetadata resultMetadata)
      throws cn.com.google.zxing1.FormatException {
   ...
   * @return The next index into the codeword array.
   */
  private static int numericCompaction(int[] codewords, int codeIndex, StringBuilder result) throws cn.com.google.zxing1.FormatException {
    int count = 0;
    boolean end = false;
   ...
   */
  private static String decodeBase900toBase10(int[] codewords, int count) throws cn.com.google.zxing1.FormatException {
