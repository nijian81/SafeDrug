...
import cn.com.google.zxing1.ResultPointCallback;
import cn.com.google.zxing1.common.BitArray;
...
public final class RSS14Reader extends AbstractRSSReader {
  ...
  private static cn.com.google.zxing1.Result constructResult(Pair leftPair, Pair rightPair) {
  ...
  private Pair decodePair(BitArray row, boolean right, int rowNumber, Map<DecodeHintType,?> hints) {
    try {
      ...
      cn.com.google.zxing1.oned.rss.FinderPattern pattern = parseFoundFinderPattern(row, rowNumber, right, startEnd);
  ...
  private DataCharacter decodeDataCharacter(BitArray row, cn.com.google.zxing1.oned.rss.FinderPattern pattern, boolean outsideChar)
    ...
    if (outsideChar) {
      ...
      int vOdd = cn.com.google.zxing1.oned.rss.RSSUtils.getRSSvalue(oddCounts, oddWidest, false);
      int vEven = cn.com.google.zxing1.oned.rss.RSSUtils.getRSSvalue(evenCounts, evenWidest, true);
  ...
  private cn.com.google.zxing1.oned.rss.FinderPattern parseFoundFinderPattern(BitArray row, int rowNumber, boolean right, int[] startEnd)
      throws NotFoundException {
    ...
    return new cn.com.google.zxing1.oned.rss.FinderPattern(value, new int[] {firstElementStart, startEnd[1]}, start, end, rowNumber);
  }
