...
package cn.com.google.zxing1.oned.rss.expanded;

import cn.com.google.zxing1.oned.OneDReader;
import cn.com.google.zxing1.oned.rss.FinderPattern;
import cn.com.google.zxing1.oned.rss.expanded.decoders.AbstractExpandedDecoder;
 ...
 */
public final class RSSExpandedReader extends cn.com.google.zxing1.oned.rss.AbstractRSSReader {
  ...
  public cn.com.google.zxing1.Result decodeRow(int rowNumber,
                          ...
                          Map<cn.com.google.zxing1.DecodeHintType,?> hints) throws cn.com.google.zxing1.NotFoundException, cn.com.google.zxing1.FormatException {
  ...
  List<ExpandedPair> decodeRow2pairs(int rowNumber, cn.com.google.zxing1.common.BitArray row) throws cn.com.google.zxing1.NotFoundException {
    try {
      while (true){
    ...
    } catch (cn.com.google.zxing1.NotFoundException nfe) {
  ...
  private List<ExpandedPair> checkRows(List<ExpandedRow> collectedRows, int currentRow) throws cn.com.google.zxing1.NotFoundException {
  ...
  static cn.com.google.zxing1.Result constructResult(List<ExpandedPair> pairs) throws cn.com.google.zxing1.NotFoundException, cn.com.google.zxing1.FormatException {
    cn.com.google.zxing1.common.BitArray binary = BitArrayBuilder.buildBitArray(pairs);

    AbstractExpandedDecoder decoder = AbstractExpandedDecoder.createDecoder(binary);
    String resultingString = decoder.parseInformation();

    cn.com.google.zxing1.ResultPoint[] firstPoints = pairs.get(0).getFinderPattern().getResultPoints();
    cn.com.google.zxing1.ResultPoint[] lastPoints  = pairs.get(pairs.size() - 1).getFinderPattern().getResultPoints();

    return new cn.com.google.zxing1.Result(
          resultingString,
          null,
          new cn.com.google.zxing1.ResultPoint[]{firstPoints[0], firstPoints[1], lastPoints[0], lastPoints[1]},
  ...
  private boolean checkChecksum() {
    ...
    cn.com.google.zxing1.oned.rss.DataCharacter checkCharacter = firstPair.getLeftChar();
    cn.com.google.zxing1.oned.rss.DataCharacter firstCharacter = firstPair.getRightChar();
    ...
    for(int i = 1; i < this.pairs.size(); ++i){
      ...
      s++;
      cn.com.google.zxing1.oned.rss.DataCharacter currentRightChar = currentPair.getRightChar();
  ...
  private static int getNextSecondBar(cn.com.google.zxing1.common.BitArray row, int initialPos){
    int currentPos;
  ...
  // not private for testing
  ExpandedPair retrieveNextPair(cn.com.google.zxing1.common.BitArray row, List<ExpandedPair> previousPairs, int rowNumber)
    ...
    cn.com.google.zxing1.oned.rss.DataCharacter leftChar  = this.decodeDataCharacter(row, pattern, isOddPattern, true);
    
    if (!previousPairs.isEmpty() && previousPairs.get(previousPairs.size()-1).mustBeLast()) {
      throw cn.com.google.zxing1.NotFoundException.getNotFoundInstance();
    }
    
    cn.com.google.zxing1.oned.rss.DataCharacter rightChar;
    try {
      rightChar = this.decodeDataCharacter(row, pattern, isOddPattern, false);
    } catch(cn.com.google.zxing1.NotFoundException ignored) {
      rightChar = null;
    }
  ...
  private void findNextPair(cn.com.google.zxing1.common.BitArray row, List<ExpandedPair> previousPairs, int forcedOffset)
      throws cn.com.google.zxing1.NotFoundException {
  ...
  private FinderPattern parseFoundFinderPattern(cn.com.google.zxing1.common.BitArray row, int rowNumber, boolean oddPattern) {
  ...
  cn.com.google.zxing1.oned.rss.DataCharacter decodeDataCharacter(cn.com.google.zxing1.common.BitArray row,
                                    FinderPattern pattern,
                                    boolean isOddPattern,
                                    boolean leftChar) throws cn.com.google.zxing1.NotFoundException {
    ...
    int vOdd = cn.com.google.zxing1.oned.rss.RSSUtils.getRSSvalue(oddCounts, oddWidest, true);
    int vEven = cn.com.google.zxing1.oned.rss.RSSUtils.getRSSvalue(evenCounts, evenWidest, false);
    int tEven = EVEN_TOTAL_SUBSET[group];
    int gSum = GSUM[group];
    int value = vOdd * tEven + vEven + gSum;

    return new cn.com.google.zxing1.oned.rss.DataCharacter(value, checksumPortion);
  }
  ...
  private void adjustOddEvenCounts(int numModules) throws cn.com.google.zxing1.NotFoundException {
