...
public final class BizcardResultParser extends AbstractDoCoMoResultParser {
  ...
  @Override
  public cn.com.google.zxing1.client.result.AddressBookParsedResult parse(cn.com.google.zxing1.Result result) {
    ...
    return new cn.com.google.zxing1.client.result.AddressBookParsedResult(maybeWrap(fullName),
                                       null,
                                       null,
