...
public final class Code39Reader extends OneDReader {
  ...
  @Override
  public cn.com.google.zxing1.Result decodeRow(int rowNumber, BitArray row, Map<DecodeHintType,?> hints)
      throws NotFoundException, ChecksumException, cn.com.google.zxing1.FormatException {
  ...
  private static String decodeExtended(CharSequence encoded) throws cn.com.google.zxing1.FormatException {
