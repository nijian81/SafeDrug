...
public final class Version {
   ...
   * @throws cn.com.google.zxing1.FormatException if dimensions do correspond to a valid Data Matrix size
   */
  public static Version getVersionForDimensions(int numRows, int numColumns) throws cn.com.google.zxing1.FormatException {
