...
public abstract class OneDimensionalCodeWriter implements Writer {
  ...
  public BitMatrix encode(String contents,
                          ...
                          int width,
                          int height,
                          Map<cn.com.google.zxing1.EncodeHintType,?> hints) throws WriterException {
    if (contents.isEmpty()) {
    ...
    if (hints != null) {
      Integer sidesMarginInt = (Integer) hints.get(cn.com.google.zxing1.EncodeHintType.MARGIN);
